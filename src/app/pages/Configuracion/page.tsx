...
const ConfigItem: React.FC<{ item: ConfigItem }> = ({ item }) => {
  ...
  return (
    ...
    >
      <i className={item.icon} style={{ marginRight: '10px', color: '#3498db' }}></i>
      {item.text}
    </div>
  );
};
...
const ConfiguracionPlataforma: React.FC = () => {
  ...
  return (
    <div style={{ fontFamily: 'Arial, sans-serif', lineHeight: 1.6, margin: 0, padding: '20px', backgroundColor: '#f4f4f4' }}>
      <Head>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', backgroundColor: '#fff', padding: '20px', borderRadius: '8px', boxShadow: '0 0 10px rgba(0,0,0,0.1)' }}>
        <h1 style={{ color: '#333', textAlign: 'center' }}>Configuración de Plataforma Educativa</h1>
        ...
        <div style={{ marginTop: '20px', textAlign: 'center' }}>
          <h2><i className="fas fa-language"></i> Seleccionar Idioma</h2>
          <select
